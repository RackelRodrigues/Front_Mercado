...
const Concluido2 =()=>{
    ...
    return(
     ...
     <Conteinerinfo>
      ...
      <Subtitulo>Seu pedido está pronto para ser retirado!</Subtitulo>
      <Subtitulo>Estamos ansiosos para atendê-lo em nossa loja.</Subtitulo>
